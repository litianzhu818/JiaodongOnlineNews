...
- (void) configure {
    ...
    _backLayer.frame = CGRectInset(self.bounds, 2, 2);
    _backLayer.cornerRadius = (self.bounds.size.height-4)/2.0;
    ...
    _fillLayer.frame = CGRectInset(self.bounds, 4, 4);
    ...
    _thumbLayer.shadowPath = knobPath;  // 不加shadowPath页面动画时会卡

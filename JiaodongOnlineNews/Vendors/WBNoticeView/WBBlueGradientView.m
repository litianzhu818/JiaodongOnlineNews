...
- (void)drawRect:(CGRect)rect
{
    ...
    firstTopBlueLine.backgroundColor = [UIColor colorWithRed:105/255.0f green:208/255.0f blue:163/255.0f alpha:1.0];
    ...
    secondTopBlueLine.backgroundColor = [UIColor colorWithRed:46/255.0f green:188/255.0f blue:126/255.0f alpha:1.0];
    ...
    firstBotBlueLine.backgroundColor = [UIColor colorWithRed:18/255.0f green:149/255.0f blue:92/255.0f alpha:1.0];
    ...
    secondBotDarkLine.backgroundColor = [UIColor colorWithRed:4/255.0f green:75/255.0f blue:45/255.0f alpha:1.0];

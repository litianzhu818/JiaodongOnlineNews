...
- (void)showImage
{
    ...
    if (_photo.firstShow) { // 首次显示
        ...
        if (![_photo.url.absoluteString hasSuffix:@"gif"]) {
            ...
            [_imageView setImageWithURL:_photo.url placeholderImage:photo.placeholder options:SDWebImageRetryFailed|SDWebImageLowPriority success:^(UIImage *image, BOOL cached) {
                photo.image = image;
...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        [_imageView setImageWithURL:_photo.url placeholderImage:_photo.srcImageView.image options:SDWebImageRetryFailed|SDWebImageLowPriority success:^(UIImage *image, BOOL cached) {
